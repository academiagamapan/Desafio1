...
public class Main {
    ...
    private static void menuPrincipal() throws InterruptedException {
        ...
        do {
            ...
            System.out.printf("%10s*----------------!! SUPERMERCADO MANGUAÃ‡A !!----------------*\n",esp);
            System.out.printf("%10s*************************************************************\n",esp);
    ...
    private static void mostrarEstoque() {
        ...
        do{
            ...
            System.out.printf("%10s************************************************************\n",esp);
            System.out.printf("%15s%5sCÃ“D%5sDescrição%5sQTD%5sPREÃ‡O\n\n",esp,esp,esp,esp,esp);
      ...
      int opcao = 0;
       ...
       cliente.getCompras().setValorTotalDaCompra(calculaValorTotal());
        ...
        do {
            ...
            System.out.printf("%10s 1. Ã€ vista (dinheiro ou pix) tem 20%% de desconto\n ", esp);
            System.out.printf("%10s 2. Ã€ vista no crÃ©dito tem 10%% de desconto\n ", esp);
            System.out.printf("%10s 3. CrÃ©dito a vista com cartão banco pan tem 15%% de desconto\n ", esp);
            System.out.printf("%10s 4. Parcelado em atÃ© 3x não tem desconto\n\n ", esp);
    ...
    private static void mostrarNotaFiscal(int i) throws InterruptedException {
        ...
        do{
        System.out.printf("%10s*************************************************************\n",esp);
        System.out.printf("%10s%8sCNPJ: 00.000.000/000.99 SUPERMERCADO MANGUAÃ‡A%8s\n",esp,esp,esp);
